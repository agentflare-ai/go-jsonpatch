...
```bash
go get github.com/gogo-agent/jsonpatch
```

Then import it in your code:
```go
import "github.com/gogo-agent/jsonpatch"
```
...
import (
	...
	"github.com/gogo-agent/jsonpatch"
)
...
goos: darwin
goarch: arm64
pkg: github.com/gogo-agent/jsonpatch
cpu: Apple M3 Max
...
PASS
ok  	github.com/gogo-agent/jsonpatch	15.087s
```
